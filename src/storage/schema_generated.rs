    ...
    pub mod storage {
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TagKeyBuilder<'a, 'b, A> {
            ...
            pub fn add_key(
                ...
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(TagKey::VT_KEY, key);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ...
        impl<'a> TagIndex<'a> {
            ...
            pub fn tag(&self) -> Option<&'a str> {
                ...
                unsafe {
                    self._tab
                        .get::<::flatbuffers::ForwardsUOffset<&str>>(TagIndex::VT_TAG, None)
                }
            }
            #[inline]
            pub fn keys(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TagKey<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TagKey>>,
                    >>(TagIndex::VT_KEYS, None)
                }
            }
        }
        ...
        impl ::flatbuffers::Verifiable for TagIndex<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<TagKey>>,
        ...
        pub struct TagIndexArgs<'a> {
            ...
            pub keys: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TagKey<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TagIndexBuilder<'a, 'b, A> {
            ...
            pub fn add_tag(&mut self, tag: ::flatbuffers::WIPOffset<&'b str>) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(TagIndex::VT_TAG, tag);
            }
            #[inline]
            pub fn add_keys(
                &mut self,
                keys: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<TagKey<'b>>>,
                >,
            ) {
                self.fbb_
                    .push_slot_always::<::flatbuffers::WIPOffset<_>>(TagIndex::VT_KEYS, keys);
            }
            #[inline]
            pub fn new(
                _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
            ) -> TagIndexBuilder<'a, 'b, A> {
                let start = _fbb.start_table();
                TagIndexBuilder {
                    fbb_: _fbb,
                    start_: start,
        ...
        impl<'a> SSTableData<'a> {
            ...
            >(
                ...
                if let Some(x) = args.tag_indexes {
                    builder.add_tag_indexes(x);
                }
            ...
            pub fn tag_indexes(
                &self,
            ) -> Option<::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TagIndex<'a>>>>
            {
                // Safety:
                // Created from valid Table for this object
                // which contains a valid value in this slot
                unsafe {
                    self._tab.get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TagIndex>>,
                    >>(SSTableData::VT_TAG_INDEXES, None)
                }
            }
        }
        ...
        impl ::flatbuffers::Verifiable for SSTableData<'_> {
            ...
            fn run_verifier(
                ...
                v.visit_table(pos)?
                    ...
                    .visit_field::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<TagIndex>>,
                    >>("tag_indexes", Self::VT_TAG_INDEXES, false)?
                    .finish();
                Ok(())
            }
        }
        pub struct SSTableDataArgs<'a> {
            ...
            pub num_hashes: u32,
            pub tag_indexes: Option<
                ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'a, ::flatbuffers::ForwardsUOffset<TagIndex<'a>>>,
                >,
            >,
        }
        ...
        impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SSTableDataBuilder<'a, 'b, A> {
            ...
            #[inline]
            pub fn add_tag_indexes(
                &mut self,
                tag_indexes: ::flatbuffers::WIPOffset<
                    ::flatbuffers::Vector<'b, ::flatbuffers::ForwardsUOffset<TagIndex<'b>>>,
                >,
            ) {
                self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                    SSTableData::VT_TAG_INDEXES,
                    tag_indexes,
                );
            }
            #[inline]
