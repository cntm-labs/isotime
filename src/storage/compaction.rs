...
mod tests {
    ...
    fn test_compaction_basic() {
        ...
        // Compact
        Compactor::compact(&[&sst1_path, &sst2_path], &merged_path, None, CompressionPolicy::Balanced).unwrap();
    ...
    async fn test_compaction_flow() {
        ...
        // Compact all
        Compactor::compact(&[&sst_a_path, &sst_b_path, &sst_c_path], &final_path, None, CompressionPolicy::Balanced).unwrap();
